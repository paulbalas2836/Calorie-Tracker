import {macroNutrients, microNutrients} from "./ReactiveConstants";

export function useInitMicroNutrients(potassium, sodium, calcium, cholesterol, iron) {
...
export function useInitMacroNutrient(macroNutrientChart, chartRef, calories, fiber, proteins, fats, carbs) {
